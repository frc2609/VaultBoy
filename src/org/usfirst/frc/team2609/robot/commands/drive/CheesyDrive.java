...
public class CheesyDrive {
    ...
    public void drive(double throttle, double wheel, boolean isQuickTurn,
         ...
         Robot.drivetrain.setDrive(DriveState.TELEOP, leftPwm, rightPwm);

         SmartDashboard.putNumber("left cheezy raw", leftPwm);
         SmartDashboard.putNumber("right cheezy raw", rightPwm);
         SmartDashboard.putNumber("angular cheezy power", leftPwm);
         SmartDashboard.putNumber("linear cheezy power", rightPwm);
