...
public class DriveStraightSpecialReverse extends Command {
	...
	double absLeftPosition = Math.abs(RobotMap.driveLeft1.getSensorCollection().getQuadraturePosition());
    ...
    protected void initialize() {
    	...
    	absLeftPosition = Math.abs(RobotMap.driveLeft1.getSensorCollection().getQuadraturePosition());
    ...
    protected void execute() {
    	...
    	driveLeftOutput = driveLeft.calcPID(RobotMap.driveLeft1.getSensorCollection().getQuadraturePosition());
